...
const Disability = ({ pkid, onAcceptClick, citizensPkId, selectedTab, subVitalList }) => {
                        ...
                        <FormControl fullWidth size="small">
                            ...
                            >
                                ...
                                {languageDelay.map((item) => (
                                    <MenuItem key={item.language_delay_id} value={item.language_delay_id}>
                                        {item.language_delay}
                                    </MenuItem>
                                ))}
                            </Select>
                    ...
                    <FormControl fullWidth size="small">
                        ...
                        >
                            ...
                            {behavioural.map((item) => (
                                <MenuItem key={item.behavioural_disorder_id} value={item.behavioural_disorder_id}>
                ...
                <Grid item xs={12} md={4}>
                    <FormControl fullWidth size="small">
                        ...
                        >
                            <MenuItem value="">Select</MenuItem>
                            {speech.map((item) => (
                                <MenuItem key={item.speech_screening_id} value={item.speech_screening_id}>
