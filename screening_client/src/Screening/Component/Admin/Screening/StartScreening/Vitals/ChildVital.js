...
const Childvital = ({
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch(
                    `${Port}/Screening/citizen_basic_info_get/${pkid}/`,
                    {
                        headers: {
                            Authorization: `Bearer ${accessToken}`,
                        },
    ...
    const updateDataInDatabase = async (citizen_id, confirmationStatus) => {
        try {
            const response = await fetch(
                `${Port}/Screening/citizen_basic_info_put/${citizen_id}/`,
                {
                    method: "PUT",
                    headers: {
                        Authorization: `Bearer ${accessToken}`,
    ...
    return (
        <div>
            ...
            >
                <DialogContent>
                    <Typography>Are you sure you want to submit the Citizen Form?</Typography>
                </DialogContent>
                <DialogActions>
