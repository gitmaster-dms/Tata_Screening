              ...
              <>
                <Box sx={{ mt: 2 }}>
                  ...
                  <Card sx={{ p: 0, mb: 1, borderRadius: "18px" }}>
                    <Grid container spacing={2} alignItems="center">
                      <Grid item xs={12} sm={3}>
                        <Typography sx={{ fontWeight: 500, fontSize: "15px", ml: 2 }}>Oral Hygiene</Typography>
                      </Grid>
                      <Grid item xs={12} sm={5}>
                        ...
                        >
                          <FormControlLabel sx={{ fontSize: '14px' }} value="1" control={<Radio />} label="Good" />
                          <FormControlLabel sx={{ fontSize: '14px' }} value="2" control={<Radio />} label="Fair" />
                          <FormControlLabel sx={{ fontSize: '14px' }} value="3" control={<Radio />} label="Poor" />
                        </RadioGroup>
                      </Grid>
                      <Grid item xs={12} sm={3}>
                        <TextField
                  ...
                  <Card sx={{ p: 0, mb: 1, borderRadius: "18px" }}>
                    <Grid container spacing={2} alignItems="center">
                      <Grid item xs={12} sm={3}>
                        <Typography sx={{ fontWeight: 500, fontSize: "15px", ml: 2 }}>Gum Condition</Typography>
                      </Grid>
                      <Grid item xs={12} sm={5}>
                        <RadioGroup
                          row
                  ...
                  <Card sx={{ p: 0, mb: 1, borderRadius: "18px" }}>
                    <Grid container spacing={2} alignItems="center">
                      <Grid item xs={12} sm={3}>
                        <Typography sx={{ fontWeight: 500, fontSize: "15px", ml: 2 }}>Oral Ulcers</Typography>
                      </Grid>
                      <Grid item xs={12} sm={5}>
                        <RadioGroup
                          row
                          ...
                          onChange={handleRadioChange}
                        >
                          <FormControlLabel sx={{ fontSize: '14px' }} value="2" control={<Radio />} label="Yes" />
                          <FormControlLabel sx={{ fontSize: '14px' }} value="1" control={<Radio />} label="No" />
                        </RadioGroup>
                      </Grid>
                      <Grid item xs={12} sm={3}>
                        <TextField
                  ...
                  <Card sx={{ p: 0, mb: 1, borderRadius: "18px" }}>
                    <Grid container spacing={2} alignItems="center">
                      <Grid item xs={12} sm={3}>
                        <Typography sx={{ fontWeight: 500, fontSize: "15px", ml: 2 }}>Gum Bleeding</Typography>
                      </Grid>
                      <Grid item xs={12} sm={5}>
                        <RadioGroup
                          row
                  ...
                  <Card sx={{ p: 0, mb: 1, borderRadius: "18px" }}>
                    <Grid container spacing={2} alignItems="center">
                      <Grid item xs={12} sm={3}>
                        <Typography sx={{ fontWeight: 500, fontSize: "15px", ml: 2 }}>Discolouration Of Teeth</Typography>
                      </Grid>
                      <Grid item xs={12} sm={5}>
                        <RadioGroup
                          row
                  ...
                  <Card sx={{ p: 0, mb: 1, borderRadius: "18px" }}>
                    <Grid container spacing={2} alignItems="center">
                      <Grid item xs={12} sm={3}>
                        <Typography sx={{ fontWeight: 500, fontSize: "15px", ml: 2 }}>Food Impaction</Typography>
                      </Grid>
                      <Grid item xs={12} sm={5}>
                        <RadioGroup
                          row
                  ...
                  <Card sx={{ p: 0, mb: 1, borderRadius: "18px" }}>
                    <Grid container spacing={2} alignItems="center">
                      <Grid item xs={12} sm={3}>
                        <Typography sx={{ fontWeight: 500, fontSize: "15px", ml: 2 }}>Carious Teeth</Typography>
                      </Grid>
                      <Grid item xs={12} sm={5}>
                        <RadioGroup
                          row
                  ...
                  <Card sx={{ p: 0, mb: 1, borderRadius: "18px" }}>
                    <Grid container spacing={2} alignItems="center">
                      <Grid item xs={12} sm={3}>
                        <Typography sx={{ fontWeight: 500, fontSize: "15px", ml: 2 }}>Extraction Done</Typography>
                      </Grid>
                      <Grid item xs={12} sm={5}>
                        <RadioGroup
                          row
                  ...
                  <Card sx={{ p: 0, mb: 1, borderRadius: "18px" }}>
                    <Grid container spacing={2} alignItems="center">
                      <Grid item xs={12} sm={3}>
                        <Typography sx={{ fontWeight: 500, fontSize: "15px", ml: 2 }}>Fluorosis</Typography>
                      </Grid>
                      <Grid item xs={12} sm={5}>
                        <RadioGroup
                          row
                  ...
                  <Card sx={{ p: 0, mb: 1, borderRadius: "18px" }}>
                    <Grid container spacing={2} alignItems="center">
                      <Grid item xs={12} sm={3}>
                        <Typography sx={{ fontWeight: 500, fontSize: "15px", ml: 2 }}>Tooth Brushing Frequency</Typography>
                      </Grid>
                      <Grid item xs={12} sm={5}>
                        <RadioGroup
                          row
                          ...
                          onChange={handleRadioChange}
                        >
                          <FormControlLabel sx={{ fontSize: '14px' }} value="3" control={<Radio />} label="1/day" />
                          <FormControlLabel sx={{ fontSize: '14px' }} value="2" control={<Radio />} label="2/day" />
                          <FormControlLabel sx={{ fontSize: '14px' }} value="1" control={<Radio />} label="Less Than 1 Day" />
                        </RadioGroup>
                      </Grid>
                      <Grid item xs={12} sm={3}>
                        <TextField
...

          {
            ['UG-EXPERT', 'UG-SUPERADMIN', 'UG-ADMIN', 'CO-HR'].includes(userGroup) && (
              <>
                <Card sx={{ p: 0, mb: 1, borderRadius: "18px" }}>
                  <Grid container spacing={2} alignItems="center">
                    <Grid item xs={12} md={3}>
                      <Typography variant="subtitle1" sx={{ fontWeight: 500, fontSize: "15px", ml: 2 }}>
                        Sensitive Teeth
                      </Typography>
                    </Grid>
                ...
                <Card sx={{ mb: 1, borderRadius: 2, boxShadow: 2, borderRadius: "18px" }}>
                  <Grid container spacing={2} alignItems="center">
                    <Grid item xs={12} md={3}>
                      <Typography variant="subtitle1" sx={{ fontWeight: 500, fontSize: "15px", ml: 2 }}>
                        Malalignment
                    ...
                    <Grid item xs={12} md={5}>
                      <FormControl component="fieldset">
                        <RadioGroup
                          ...
                          onChange={handleRadioChange}
                        >
                          <FormControlLabel sx={{ fontSize: '14px' }} value={1} control={<Radio />} label="Yes" />
                          <FormControlLabel sx={{ fontSize: '14px' }} value={2} control={<Radio />} label="No" />
                        </RadioGroup>
                      </FormControl>
                    </Grid>
