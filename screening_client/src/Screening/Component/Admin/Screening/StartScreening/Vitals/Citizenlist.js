                  ...
                  <Box>
                    <div class="container text-center">
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            {ListGenderNav.map((drop) => (
                              <MenuItem
                                key={drop.gender_pk_id}
                                value={drop.gender_pk_id}
                              >
                                {drop.gender}
                              </MenuItem>
                            ))}
                        ...
                        >
                          ...
                          >
                            ...
                            {ListDiseaseNav.map((drop) => (
                              <MenuItem
                                key={drop.disease_pk_id}
                                value={drop.disease_pk_id}
                              >
                                {drop.disease}
                              </MenuItem>
                            ))}
                        ...
                        {canAddCitizen && (
                          <Link to="/mainscreen/Citizenheader">
                            <div>
                  ...
                  {loading ? (
                    <tr>
                      <td colSpan="7" className="text-center">
                        <CircularProgress
                          className="circular-progress-containercitizenlist"
                          style={{ margin: "auto" }}
                        />
                      </td>
                    </tr>
                      ...
                      .map((data, index) => {
                        ...
                        return (
                          <tr key={data.srNo} className="card cardbodyuser">
                            ...
                            <td className="col-md-3 headbody">
                              {data.name
                                ? data.name
                                    .toLowerCase()
                                    .charAt(0)
                            ...
                            <td className="col-md-2 headbody">
                              {data.year} Year
                            </td>
                            <td className="col-md-3 headbody">
                              {data.source_name_name}
                            </td>
                            <td className="col-md-1 headbody">
