                ...
                <Grid container spacing={2} sx={{ mb: 3 }} key={i}>
                    ...
                    <Grid container spacing={2}>
                      <Grid item xs={12} md={4}>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleFileChange(e, "investigation_report")
                          }
                          style={{ width: "100%" }}
                        />
                      </Grid>
                      {Array.isArray(investData) &&
                        investData.length > 0 &&
                        investData[0].investigation_report !==
                          "/media/undefined" && (
                          <Grid
                            item
                            xs={12}
                  ...
                  {data.submoduleName === "Urine Report" && (
                    <Grid container spacing={2}>
                      ...
                      {Array.isArray(investData) &&
                        investData.length > 0 &&
                        investData[0].urine_report !== "/media/undefined" && (
                          <Grid
                            item
                            xs={12}
                            md={4}
                          ...
                          >
                            <Button
                              ...
                              startIcon={<CloudDownloadOutlinedIcon />}
                              onClick={() =>
                                downloadFile(investData[0]?.urine_report)
                              }
                            >
                              Download
                            </Button>
                  ...
                  {data.submoduleName === "ECG Report" && (
                    <Grid container spacing={2}>
                      ...
                      {Array.isArray(investData) &&
                        investData.length > 0 &&
                        investData[0].ecg_report !== "/media/undefined" && (
                          <Grid
                            item
                            xs={12}
                            md={4}
                          ...
                          >
                            <Button
                              ...
                              startIcon={<CloudDownloadOutlinedIcon />}
                              onClick={() =>
                                downloadFile(investData[0]?.ecg_report)
                              }
                            >
                              Download
                            </Button>
                  ...
                  {data.submoduleName === "X-Ray Report" && (
                    <Grid container spacing={2}>
                      ...
                      {Array.isArray(investData) &&
                        investData.length > 0 &&
                        investData[0].x_ray_report !== "/media/undefined" && (
                          <Grid
                            item
                            xs={12}
                            md={4}
                          ...
                          >
                            <Button
                              ...
                              startIcon={<CloudDownloadOutlinedIcon />}
                              onClick={() =>
                                downloadFile(investData[0]?.x_ray_report)
                              }
                            >
                              Download
                            </Button>
